...
<body>
        ...
        <div class="info-panel">
            ...
            <div class="info-content">
                <div class="logo-container">
                    <img
                        src="/assets/images/owlie_icn_transparent.png"
                        alt="STI DigiLibrary Logo"
                        class="logo-img" />
                </div>
                <h1 class="info-title">STI DigiLibrary</h1>
                <p class="info-description">
                    Your gateway to a world of knowledge. Access resources, manage
                    loans, and connect with our academic community.
                </p>
            </div>
        </div>
        ...
        <div class="form-panel">
            <form class="form" id="login">
                ...
                <p class="form-text">
                    ...
                    <a href="#" class="form-link" id="linkCreateAccount">Sign Up</a>
                </p>
                <button
                    class="admin-toggle-button"
                    id="adminToggle"
                    aria-label="Toggle admin login mode">
                    <span class="button-text">Log in as Admin</span>
                </button>
            </form>
            ...
            <form class="form form--hidden" id="signup">
                ...
                <div class="form-input-group">
                    ...
                    <div class="form-input-error-message" id="confirm-password-feedback"></div>
                </div>

                <button class="form-button" type="submit">Sign Up</button>
                <p class="form-text">
                    <a class="form-link" href="#" id="linkLogin">Already have an account? Log In</a>
                </p>
            </form>
        </div>
    </div>
    ...
    <div id="confirmResetModal" class="modal" style="display:none">
        <div class="modal-content">
            ...
            <input type="text" id="resetCodeInput" maxlength="6"
    ...
    <div id="confirmLockModal" class="modal" style="display:none">
        <div class="modal-content">
            ...
            <p>Please enter the 6-digit code sent to your email to unlock your account:</p>
            <input type="text" id="lockedCodeInput" maxlength="6"
                placeholder="Enter 6-digit code" style="text-align:center; margin-top:1rem;" />
    ...
    <script src="/assets/js/login/main.js" type="module"></script>
</body>
